 ...
 *  - GPIO 10 ---> VGA Hsync
 *  - GPIO 11 ---> VGA Vsync
 *  - GPIO 12 ---> 470 ohm resistor ---> VGA Green 
 *  - GPIO 13 ---> 330 ohm resistor ---> VGA Green
...
// Give the I/O pins that we're using some names that make sense - usable in main()
 enum vga_pins {HSYNC=10, VSYNC, LO_GRN, HI_GRN, BLUE_PIN, RED_PIN} ;
